...
curl -SL -s "https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-server/refs/heads/fix/ubuntu-user-interation/scripts/install.sh" > "$TMP_FOLDER/install-wazuh-server.sh"
