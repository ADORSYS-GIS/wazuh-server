...
if [ -f /etc/debian_version ]; then
    ...
    GPG_IMPORT_CMD="rpm --import https://packages.wazuh.com/key/GPG-KEY-WAZUH"
...
config() {
    REPO_URL="https://raw.githubusercontent.com/ADORSYS-GIS/wazuh-agent/${WAZUH_SERVER_REPO_REF}"
