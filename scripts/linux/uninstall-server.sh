...
download_and_verify_file "$WAZUH_SERVER_REPO_URL/$linux_uninstall_pattern" "$TMP_FOLDER/uninstall-agent.sh" "$linux_uninstall_pattern" "Wazuh agent uninstall script" "$WAZUH_SERVER_REPO_URL/checksums.sha256"
